...
- Projects targeting Windows UI apps must set `TargetFramework` to `net9.0-windows` and `UseWindowsForms` as needed. Prefer centralizing common properties in `Directory.Build.props` at repo root.
...
- Fork the repo or create a feature branch from `main` named `feat/<short-description>`, `docs/<short-description>` or `fix/<short-description>`.
...
- Use `dotnet build` from the project root.
...
- `CHANGELOG.md` - log of changes as per https://keepachangelog.com/en/1.1.0/
- `CONTRIBUTING.md` - this file
- `LICENSE` - MIT license
- `README.md` - Repo documentation and usage guide
